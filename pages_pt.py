...
P = {
    # ================================================== COMO FUNCIONA =======
    "howto_title": "Como funciona o Sincro",
    "howto_desc": "Passo a passo do Sincro: copiar os cartões com verificação, "
    ...
    "howto_ing_steps": [
        ("Escolha o destino e nomeie o job",
         ...
         "Enquanto você digita, o Sincro mostra o caminho real que vai nascer "
         "no disco, já com a data na frente. O que aparece na tela é "
         "literalmente a pasta que vai existir."),
        ("Solte os cartões",
         "Arraste um cartão, vários, ou pastas já copiadas. O Sincro lê a "
    ...
    "howto_ing_tip_p": "O Sincro copia, sempre. Mover apaga a origem antes de "
    ...
    "howto_sync_steps": [
        ("Organize o bruto em pastas por fonte",
         "Uma pasta por câmera, uma por gravador. O Sincro usa a pasta para "
        ...
        ("Solte tudo de uma vez",
         "Arraste a pasta da diária inteira. O Sincro faz um reconhecimento "
        ...
        ("Ouça antes de exportar",
         "Clique em qualquer ponto e dê play. O Sincro mixa em tempo real "
    ...
    "howto_thresholds_p": "A engrenagem no topo abre dois limiares. "
                          ...
                          "Sincro aceitar um alinhamento. <strong>Lock "
    ...
    "howto_out": [
        ...
        ("A sobreposição é curta demais",
         ...
         "O Sincro pesa a evidência pelo tamanho da sobreposição justamente "
         "para não cair nisso."),
    ...
    "howto_export": [
        ...
        ("DaVinci Resolve",
         ...
         "&rsaquo; Timeline. A mídia linka sozinha. Como alternativa, o Sincro "
        ...
        ("Multicam nativo",
         ...
         "Sincro escreve o mesmo timecode para todas as câmeras no XML, e a "
    ...
    "howto_faq": [
        ...
        ("E se eu tiver um gravador de várias faixas?",
         ...
         "canal, coloque-os na mesma pasta: o Sincro os trata como o mesmo "
    ...
    "pe_desc": "O PluralEyes saiu de cena. O Sincro sincroniza a diária pelo "
    ...
    "pe_page_lede": "Por quase quinze anos, sincronizar multicam por áudio "
                    ...
                    "mais confiável que existe numa diária. O Sincro parte "
    ...
    "pe_why": [
        ...
        ("Um botão, a diária inteira",
         ...
         "material dentro, timeline fora. O Sincro mantém isso."),
    ...
    "pe_diff_h2": "O que muda no Sincro",
    "pe_diff": [
        ...
        ("A confiança fica visível",
         "Cada alinhamento carrega uma nota. O Sincro separa o que travou, o "
    ...
    "pe_move": [
        ("Mantenha suas pastas como estão",
         ...
         "PluralEyes pedia, e o Sincro lê exatamente isso."),
    ...
    # ====================================================== NOVIDADES =======
    "wn_title": "Novidades do Sincro",
    "wn_desc": "O que mudou em cada versão do Sincro.",
    "wn_eyebrow": "Registro",
    "wn_h1": "Novidades",

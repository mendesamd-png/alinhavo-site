...
P = {
    # =================================================== HOW IT WORKS =======
    "howto_title": "How Sincro works",
    "howto_desc": "A walkthrough of Sincro: copy cards with verification, sync "
    ...
    "howto_ing_steps": [
        ("Pick the destination and name the job",
         ...
         "name. As you type, Sincro shows the real path that will exist on "
         "disk, with the date already in front. What appears on screen is "
         "literally the folder that gets created."),
        ("Drop the cards",
         "Drag in one card, several, or folders you already copied. Sincro "
    ...
    "howto_ing_tip_p": "Sincro copies, always. Moving erases the source before "
    ...
    "howto_sync_steps": [
        ("Organize the raw footage in folders by source",
         "One folder per camera, one per recorder. Sincro uses the folder to "
        ...
        ("Drop it all at once",
         "Drag in the whole shoot day. Sincro does a quick pass without "
        ...
        ("Listen before you export",
         "Click anywhere and hit play. Sincro mixes every clip under the "
    ...
    "howto_thresholds_p": "The gear icon up top opens two thresholds. "
                          ...
                          "Sincro to accept an alignment at all. <strong>Lock "
    ...
    "howto_out": [
        ...
        ("The overlap is too short",
         ...
         "isn't. Sincro weighs the evidence by how much overlap it had, "
    ...
    "howto_export": [
        ...
        ("DaVinci Resolve",
         ...
         "&rsaquo; Timeline. Media links itself. As an alternative, Sincro "
        ...
        ("Native multicam",
         ...
         "Sincro writes the same timecode across every camera in the XML, and "
    ...
    "howto_faq": [
        ...
        ("What about a multitrack recorder?",
         ...
         "channel, put them in the same folder: Sincro treats them as the same "
    ...
    "pe_desc": "PluralEyes is gone. Sincro syncs your shoot day by audio, runs "
    ...
    "pe_page_lede": "For nearly fifteen years, syncing multicam by audio meant "
                    ...
                    "shoot day has. Sincro starts from that same principle and "
    ...
    "pe_why": [
        ...
        ("One button, the whole day",
         ...
         "in, timeline out. Sincro keeps that."),
    ...
    "pe_diff_h2": "What changes in Sincro",
    "pe_diff": [
        ("Native on Apple Silicon",
         "Processing runs directly on your Mac, with no translation layer. "
         "Nothing is sent to any server."),
        ("Confidence you can see",
         "Every alignment carries a score. Sincro separates what locked, what "
    ...
    "pe_move": [
        ("Keep your folders as they are",
         ...
         "PluralEyes asked for, and exactly what Sincro reads."),
    ...
    # ======================================================== WHAT'S NEW ====
    "wn_title": "What's new in Sincro",
    "wn_desc": "What changed in each version of Sincro.",
